...
class TestDoctorList:
    ...
    def test_create_doctor_duplicate_crm(self, client):
    ...
    def test_create_doctor_missing_fields(self, client):
        resp = client.post("/api/v1/doctors", json={"name": "Incomplete"})
...
class TestDoctorDetail:
    ...
    def test_delete(self, client):
        ...
        resp = client.delete("/api/v1/doctors/CRM_DEL")
    ...
    def test_delete_not_found(self, client):
        resp = client.delete("/api/v1/doctors/GHOST")
        assert resp.status_code == 404
